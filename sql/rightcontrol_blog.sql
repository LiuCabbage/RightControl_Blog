...
INSERT INTO `t_article` VALUES ('4', 'ASP.NET MVC 使用分部视图制作公共头部，尾部，并通过ViewBag传值', ' 一：新建分部视图 二：布局页_Layout.cshtml上调用 不灵活，不能传递数据，引用静态公共部分 通过控制器方法引入分部视图，控制器里可以向分部视图传递数据，引用动态公共部分 三：代码展示： 布局页_Layout.cshtml，因为@RenderSection只能放在布局页，所以@Html.Action(\"Foot\", \"Home\")下面的一坨就没放在_Foot里面，会报错。', '/Upload/img/1260852-20190712145504706-1458531772.jpg', '<p>一：新建分部视图</p><p><img src=\"https://img2018.cnblogs.com/blog/1260852/201907/1260852-20190712142228947-51827939.jpg\" alt=\"\"></p><p>二：布局页_Layout.cshtml上调用</p><p>不灵活，不能传递数据，引用静态公共部分</p><div class=\"cnblogs_code\"><pre>@Html.Partial(<span>\"</span><span>_Head</span><span>\"</span><span>)\r\n\r\n@Html.Partial(</span><span>\"</span><span>~/Views/Shared/_Head.cshtml</span><span>\"</span>)</pre></div><p>通过控制器方法引入分部视图，控制器里可以向分部视图传递数据，引用动态公共部分</p><div class=\"cnblogs_code\"><pre>@Html.Action(<span>\"</span><span>Head</span><span>\"</span>, <span>\"</span><span>Home</span><span>\"</span>)</pre></div><p>三：代码展示：</p><p>布局页_Layout.cshtml，因为@RenderSection只能放在布局页，所以@Html.Action(\"Foot\", \"Home\")下面的一坨就没放在_Foot里面，会报错。</p><div class=\"cnblogs_code\"><pre>\r\n\r\n\r\n    <meta charset=\"<span\">\"<span>utf-8</span><span>\"</span> /&gt;\r\n    <meta name=\"<span\">\"<span>viewport</span><span>\"</span> content=<span>\"</span><span>width=device-width, initial-scale=1.0</span><span>\"</span>&gt;\r\n    <title>@ViewBag.Title</title><span>\r\n    @Html.Action(</span><span>\"</span><span>Meta</span><span>\"</span>, <span>\"</span><span>Home</span><span>\"</span><span>)\r\n    </span><link rel=\"<span\">\"<span>stylesheet</span><span>\"</span> href=<span>\"</span><span>~/Content/font-awesome/css/font-awesome.min.css</span><span>\"</span>&gt;\r\n    <link rel=\"<span\">\"<span>stylesheet</span><span>\"</span> href=<span>\"</span><span>~/Content/layui/css/layui.css</span><span>\"</span> /&gt;\r\n    <link rel=\"<span\">\"<span>stylesheet</span><span>\"</span> href=<span>\"</span><span>~/Content/css/master.css</span><span>\"</span> /&gt;\r\n    <link rel=\"<span\">\"<span>stylesheet</span><span>\"</span> href=<span>\"</span><span>~/Content/css/gloable.css</span><span>\"</span> /&gt;\r\n    <link rel=\"<span\">\"<span>stylesheet</span><span>\"</span> href=<span>\"</span><span>~/Content/css/nprogress.css</span><span>\"</span> /&gt;<span>\r\n    @RenderSection(</span><span>\"</span><span>css</span><span>\"</span>, required: <span>false</span><span>)\r\n</span>\r\n<span>\r\n    @Html.Action(</span><span>\"</span><span>Head</span><span>\"</span>, <span>\"</span><span>Home</span><span>\"</span><span>)\r\n    @RenderBody()\r\n    @Html.Action(</span><span>\"</span><span>Foot</span><span>\"</span>, <span>\"</span><span>Home</span><span>\"</span><span>)\r\n    </span><script src=\"&lt;span\">\"</span><span>~/Content/layui/layui.js</span><span>\"</span>></script>\r\n    <script src=\"&lt;span\">\"</span><span>~/Content/js/yss/gloable.js</span><span>\"</span>></script>\r\n    <script src=\"&lt;span\">\"</span><span>~/Content/js/plugins/nprogress.js</span><span>\"</span>></script>\r\n    <script>NProgress.start();</script><span>\r\n    @RenderSection(</span><span>\"</span><span>js</span><span>\"</span>, required: <span>false</span><span>)\r\n    </span><script><span>\r\n        window.onload </span>=<span> function () {\r\n            NProgress.done();\r\n        };\r\n    </span></script>\r\n    <script><span>\r\n        (function () {\r\n            </span><span>var</span> bp = document.createElement(<span>\'</span><span>script</span><span>\'</span><span>);\r\n            </span><span>var</span> curProtocol = window.location.protocol.split(<span>\'</span><span>:</span><span>\'</span>)[<span>0</span><span>];\r\n            </span><span>if</span> (curProtocol === <span>\'</span><span>https</span><span>\'</span><span>) {\r\n                bp.src </span>= <span>\'</span><span>https://zz.bdstatic.com/linksubmit/push.js</span><span>\'</span><span>;\r\n            }\r\n            </span><span>else</span><span> {\r\n                bp.src </span>= <span>\'</span><span>http://push.zhanzhang.baidu.com/push.js</span><span>\'</span><span>;\r\n            }\r\n            </span><span>var</span> s = document.getElementsByTagName(<span>\"</span><span>script</span><span>\"</span>)[<span>0</span><span>];\r\n            s.parentNode.insertBefore(bp, s);\r\n        })();\r\n    </span></script>\r\n</pre></div><p>我把控制器方法写在了首页，因为博客首页头部尾部不公共的，其实写哪里都一样，返回分部视图就ok。</p><p>首页控制器：/Home</p><p>返回分部视图千万不要用 return View(model.GetWebSiteInfo());&nbsp; 会默认找~Views/Home/ 下面的视图，严重错误，IIS Express直接崩掉自动退出</p><div class=\"cnblogs_code\"><pre><span>using</span><span> RightControl.IService;\r\n</span><span>using</span><span> RightControl.WebApp.Models;\r\n</span><span>using</span><span> System.Web.Mvc;\r\n\r\n</span><span>namespace</span><span> RightControl.WebApp.Controllers\r\n{\r\n    </span><span>public</span> <span>class</span><span> HomeController : Controller\r\n    {\r\n        </span><span>public</span> IArticleService service { <span>get</span>; <span>set</span><span>; }\r\n        WebSiteInfo model </span>= <span>new</span><span> WebSiteInfo();\r\n        </span><span>//</span><span> GET: Home</span>\r\n        <span>public</span><span> ActionResult Index()\r\n        {\r\n            ViewBag.HotArtileList </span>= service.GetHotArticle(<span>3</span><span>);\r\n            </span><span>return</span><span> View(model.GetWebSiteInfo());\r\n        }\r\n        </span><span>public</span><span> ActionResult Meta()\r\n        {\r\n            ViewBag.Site </span>=<span> model.GetWebSiteInfo();\r\n            </span><span>return</span> PartialView(<span>\"</span><span>~/Views/Shared/_Meta.cshtml</span><span>\"</span><span>);\r\n        }\r\n        </span><span>public</span><span> ActionResult Head()\r\n        {\r\n            ViewBag.Site </span>=<span> model.GetWebSiteInfo();\r\n            </span><span>return</span> PartialView(<span>\"</span><span>~/Views/Shared/_Head.cshtml</span><span>\"</span><span>);\r\n        }\r\n        </span><span>public</span><span> ActionResult Foot()\r\n        {\r\n            ViewBag.Site </span>=<span> model.GetWebSiteInfo();\r\n            </span><span>return</span> PartialView(<span>\"</span><span>/Views/Shared/_Foot.cshtml</span><span>\"</span><span>);\r\n        }\r\n    }\r\n}</span></pre></div><p>_Meta.cshtml</p><div class=\"cnblogs_code\"><pre><meta name=\"<span\">\"<span>keywords</span><span>\"</span> content=<span>\"</span><span>@ViewBag.Site.MetaKey</span><span>\"</span> /&gt;\r\n<meta name=\"<span\">\"<span>description</span><span>\"</span> content=<span>\"</span><span>@ViewBag.Site.MetaDescribe</span><span>\"</span>&gt;</pre></div><p>_Head.cshtml</p><div class=\"cnblogs_code\"><pre><div <span=\"\">class=<span>\"</span><span>header</span><span>\"</span>&gt;\r\n</div>\r\n<header <span=\"\">class=<span>\"</span><span>gird-header</span><span>\"</span>&gt;\r\n    <div <span=\"\">class=<span>\"</span><span>header-fixed</span><span>\"</span>&gt;\r\n        <div <span=\"\">class=<span>\"</span><span>header-inner</span><span>\"</span>&gt;\r\n            <a href=\"&lt;span\">\"<span>javascript:void(0)</span><span>\"</span> <span>class</span>=<span>\"</span><span>header-logo</span><span>\"</span> id=<span>\"</span><span>logo</span><span>\"</span>&gt;@ViewBag.Site.SiteName</a>\r\n            <nav <span=\"\">class=<span>\"</span><span>nav</span><span>\"</span> id=<span>\"</span><span>nav</span><span>\"</span>&gt;\r\n                <ul>\r\n                    <li><a href=\"&lt;span\">\"<span>/Home</span><span>\"</span>&gt;首页</a></li>\r\n                    <li><a href=\"&lt;span\">\"<span>/Article</span><span>\"</span>&gt;博客</a></li>\r\n                    <li><a href=\"&lt;span\">\"<span>/Feedback</span><span>\"</span>&gt;留言</a></li>\r\n                    <li><a href=\"&lt;span\">\"<span>/Diarys</span><span>\"</span>&gt;日记</a></li>\r\n                    <li><a href=\"&lt;span\">\"<span>/Links</span><span>\"</span>&gt;友链</a></li>\r\n                    <li><a href=\"&lt;span\">\"<span>/About</span><span>\"</span>&gt;关于</a></li>\r\n                </ul>\r\n            </nav>\r\n            <a href=\"&lt;span\">\"<span>/User/QQLogin</span><span>\"</span> <span>class</span>=<span>\"</span><span>blog-user</span><span>\"</span>&gt;\r\n                <i <span=\"\">class=<span>\"</span><span>fa fa-qq</span><span>\"</span>&gt;</i>\r\n            </a>\r\n            <a <span=\"\">class=<span>\"</span><span>phone-menu</span><span>\"</span>&gt;\r\n                <i></i>\r\n                <i></i>\r\n                <i></i>\r\n            </a>\r\n        </div>\r\n    </div></header></pre><div class=\"cnblogs_code_toolbar\"><br></div></div><p>_Foot.cshtml</p><div class=\"cnblogs_code\"><pre><footer <span=\"\">class=<span>\"</span><span>grid-footer</span><span>\"</span>&gt;\r\n    <div <span=\"\">class=<span>\"</span><span>footer-fixed</span><span>\"</span>&gt;\r\n        <div <span=\"\">class=<span>\"</span><span>copyright</span><span>\"</span>&gt;\r\n            <div <span=\"\">class=<span>\"</span><span>info</span><span>\"</span>&gt;\r\n                <div <span=\"\">class=<span>\"</span><span>contact</span><span>\"</span>&gt;\r\n                    <a href=\"&lt;span\">\"<span>@ViewBag.Site.Gitee</span><span>\"</span> <span>class</span>=<span>\"</span><span>github</span><span>\"</span> target=<span>\"</span><span>_blank</span><span>\"</span>&gt;<i <span=\"\">class=<span>\"</span><span>fa fa-github</span><span>\"</span>&gt;</i></a>\r\n                    <a href=\"&lt;span\">\"<span>https://wpa.qq.com/msgrd?v=3&amp;uin=@ViewBag.Site.QQ&amp;site=qq&amp;menu=yes</span><span>\"</span> <span>class</span>=<span>\"</span><span>qq</span><span>\"</span> target=<span>\"</span><span>_blank</span><span>\"</span> title=<span>\"</span><span>@ViewBag.Site.QQ</span><span>\"</span>&gt;<i <span=\"\">class=<span>\"</span><span>fa fa-qq</span><span>\"</span>&gt;</i></a>\r\n                    <a href=\"&lt;span\">\"<span>https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&amp;email=@ViewBag.Site.Mail</span><span>\"</span> <span>class</span>=<span>\"</span><span>email</span><span>\"</span> target=<span>\"</span><span>_blank</span><span>\"</span> title=<span>\"</span><span>@ViewBag.Site.Mail</span><span>\"</span>&gt;<i <span=\"\">class=<span>\"</span><span>fa fa-envelope</span><span>\"</span>&gt;</i></a>\r\n                    <a href=\"&lt;span\">\"<span>javascript:void(0)</span><span>\"</span> <span>class</span>=<span>\"</span><span>weixin</span><span>\"</span>&gt;<i <span=\"\">class=<span>\"</span><span>fa fa-weixin</span><span>\"</span>&gt;</i></a>\r\n                </div>\r\n                <p <span=\"\">class=<span>\"</span><span>mt05</span><span>\"</span>&gt;<span>\r\n                    @ViewBag.Site.CopyRight\r\n                </span></p>\r\n            </div>\r\n        </div>\r\n    </div></footer></pre><div class=\"cnblogs_code_toolbar\"><br></div></div><p>最终效果：</p><p><img src=\"/Upload/img/1260852-20190712145453950-818976929.jpg\" alt=\"undefined\"><br></p><p><img src=\"/Upload/img/1260852-20190712145504706-1458531772_1.jpg\" alt=\"undefined\"><br></p><p>头部尾部提取公共部分还有一种做法，不用分部视图，直接用布局页：</p><p>新建BaseController控制器，里面获取网站头部尾部需要的WebSiteInfo信息，除开博客首页每个页面的控制器都继承它，布局页直接使用BaseController的WebSiteInfo信息，通过ViewBag的方式给布局页头尾赋值。</p><p>最后总结，个人还是喜欢用分部视图来抽出头部尾部的，继承BaseController的方法虽然不用新建部分视图，但是也要每个有公共头尾的页面控制器去继承它，想想也有点膈应。</p>', '1', '1', '0', '0', '0', '', '2019-07-29 17:20:34', '2019-07-29 22:26:57');
...
CREATE TABLE `t_log` (
  ...
  `Status` bit(1) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='日志表';

-- ----------------------------
-- Records of t_log
-- ----------------------------
INSERT INTO `t_log` VALUES ('1', 'Login', 'admin', '超级管理员', '系统登录', '登录成功', '2019-07-29 22:18:14', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('2', 'Login', 'admin', 'admin', '系统登录', '登录失败，验证码错误，请重新输入', '2019-07-29 23:15:30', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('3', 'Login', 'admin', '超级管理员', '系统登录', '登录成功', '2019-07-29 23:15:36', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('4', 'Update', 'admin', '超级管理员', '修改密码', '密码修改成功', '2019-07-29 23:15:57', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('5', 'Exit', 'admin', '超级管理员', null, '安全退出系统', '2019-07-29 23:15:58', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('6', 'Login', 'admin', '超级管理员', '系统登录', '登录成功', '2019-07-29 23:16:03', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('7', 'Exit', 'admin', '超级管理员', null, '安全退出系统', '2019-07-29 23:16:36', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('8', 'Login', 'admin', 'admin', '系统登录', '登录失败，验证码错误，请重新输入', '2019-07-29 23:18:23', '192.168.1.2', '本地局域网', '');
INSERT INTO `t_log` VALUES ('9', 'Login', 'admin', '超级管理员', '系统登录', '登录成功', '2019-07-29 23:18:29', '192.168.1.2', '本地局域网', '');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'admin', '超级管理员', 'e10adc3949ba59abbe56e057f20f883e', '1', '', '2019-02-28 16:18:52', '2019-07-29 16:27:09', '0', '1', '1', '11111111111', '178899573@qq.com', '最高权限', '/Upload/img/502.jpg');
